function onDataLoaded3(dObj) {
    ...
    board = dY.graph.addBoard("#dy-canvas3",{inWidth: 150, inHeight:150, margin:30});
    ...
    board.g.selectAll("rect.drybar")
        ...
        // ADDING LINE GRAPH
            ...
            board2 = dY.graph.addBoard("#dy-canvas3",{inWidth: 100, inHeight:100, margin:30});
